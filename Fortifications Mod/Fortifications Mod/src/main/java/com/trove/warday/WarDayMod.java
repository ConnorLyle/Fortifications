...
public final class WarDayMod {
    public static final String LOADER_MODID = "fortifications";
    public static final String MODID = "fortifications";
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> WAR_DAY_TAB =
            CREATIVE_MODE_TABS.register("war_day", () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup.fortifications"))
    ...
    public static void initialize(IEventBus modEventBus, ModContainer modContainer) {
        ...
        modContainer.registerConfig(ModConfig.Type.SERVER, WarDayConfig.SPEC, "fortifications-server.toml");
    ...
    private static void addLegacyRegistryAliases() {
        addLegacyAlias(BLOCKS, "nexus");
        addLegacyAlias(BLOCKS, "forward_marker");
        addLegacyAlias(BLOCKS, "attacker_spawn");
        addLegacyAlias(ITEMS, "nexus");
        addLegacyAlias(ITEMS, "forward_marker");
        addLegacyAlias(ITEMS, "attacker_spawn");
        addLegacyAlias(CREATIVE_MODE_TABS, "war_day");
    }

    private static void addLegacyAlias(DeferredRegister<?> register, String path) {
        register.addAlias(
                ResourceLocation.fromNamespaceAndPath("warday", path),
